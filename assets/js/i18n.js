// Turkish translations for every element tagged with data-i18n / data-i18n-placeholder.
...
(function () {
  var TR = {
    ...
    'industries.desc': 'SaaS, yapay zeka, sağlık ve diğer hızlı sektörlerdeki ekiplerin yavaşlamadan güvenilir ürünler geliştirmesine yardımcı oluyoruz.',
    ...
    'industries.3.title': 'Mobil uygulamalar',
    'industries.3.desc': 'Güçlü veri pratikleri ve akıcı performansla net, tutarlı mobil deneyimler.',
  ...
  window.siteLang = function () { return root.getAttribute('lang') === 'tr' ? 'tr' : 'en'; };
  window.siteText = function (key) {
    return (window.siteLang() === 'tr' ? TR : EN)[key] || TR[key] || '';
  };
  ...
  document.querySelectorAll('.lang-toggle').forEach(function (btn) {
    btn.addEventListener('click', function () {
      apply(window.siteLang() === 'tr' ? 'en' : 'tr');
    });
  });
})();
